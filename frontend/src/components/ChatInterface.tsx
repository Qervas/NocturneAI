...
import { User, Brain, AlertCircle, Clock, TrendingUp, Users } from 'lucide-react';
        ...
        <div className="flex items-center justify-center h-full">
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium text-slate-300 mb-2">
              Welcome to Your Intelligence Empire
            </h3>
            <p className="text-slate-400 max-w-md">
              Your AI Council is ready to provide strategic guidance. Ask questions about 
              product strategy, market analysis, design decisions, or operational planning.
            </p>
