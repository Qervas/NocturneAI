...
currentAgentStore.set(databaseManager.getAgent('agent-alpha') || null);
...
agentCapabilitiesStore.set(databaseManager.getAgent('agent-alpha')?.capabilities || []);